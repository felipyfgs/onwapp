...
func (h *AuthHandler) Register(c *fiber.Ctx) error {
	...
	// Get tenant ID from request (this would come from multi-tenancy middleware in production)
	tenantID := uuid.New() // TODO: Replace with actual tenant ID from context
