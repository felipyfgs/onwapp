...
export class MediaController {
  ...
  @ApiOkResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        mediaKey: {
          type: 'string',
          description: 'Chave de criptografia (base64)',
        },
        fileEncSha256: {
          type: 'string',
          description: 'SHA256 do arquivo criptografado (base64)',
        },
        fileSha256: {
          type: 'string',
          description: 'SHA256 do arquivo (base64)',
        },
        fileLength: { type: 'number', description: 'Tamanho do arquivo' },
        mediaKeyTimestamp: {
          type: 'number',
          description: 'Timestamp da chave',
        },
      },
    },
  })
  ...
  async uploadToServer(
    ...
    return this.mediaService.uploadToServer(
      sessionId,
      dto.mediaType,
      dto.filePath,
      dto.fileEncSha256B64,
    );
  }
}
