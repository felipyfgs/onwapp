...
func (r *MediaRepository) Save(ctx context.Context, m *model.Media) (string, error) {
	...
	err := r.pool.QueryRow(ctx, `
		...
		ON CONFLICT ("sessionId", "msgId") DO UPDATE SET
			"storageKey" = COALESCE(EXCLUDED."storageKey", "zpMedia"."storageKey"),
			"storageUrl" = COALESCE(EXCLUDED."storageUrl", "zpMedia"."storageUrl"),
			"storedAt" = COALESCE(EXCLUDED."storedAt", "zpMedia"."storedAt"),
			"downloaded" = COALESCE(EXCLUDED."downloaded", "zpMedia"."downloaded"),
